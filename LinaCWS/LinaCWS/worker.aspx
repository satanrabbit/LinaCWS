<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="worker.aspx.cs" Inherits="LinaCWS.worker" %>
               ...
               // title: "全部文章",
                ...
                columns: [[
                    {
                        ...
                        title: "入职时间",
                        field: "wkEntryTime", sortable: true,
                        width: 180,
                        align: 'center'
                    }, {
                        title: "职位",
                ...
                toolbar: [
                    {
                        ...
                        iconCls: "icon-add",
                        handler: function () {
                            $.sr_edit_dialog("workerEdit.aspx", { title: "修改员工信息", form: "editForm" }, function (data) {
                                data = $.parseJSON(data);
                                if (data.status === 1) {
                                    $dd.datagrid("reload");
                        ...
                        handler: function () {
                            ...
                            $.messager.confirm("提示", "删除操作将不可逆！<br />请确认！", function (b) {
                                if (b) {
                                    ...
                                    dids = dids.join(",");
                                    $.delete_data("workerDelete.ashx", { did: dids });
                                }
                            });
                        }
                    },
                ...
                onLoadSuccess: function (data) {
                    ...
                    $(".art_edit_btn").click(function () {
                        ...
                        $.sr_edit_dialog("workerEdit.aspx", { title: "修改员工信息", form: "editForm", did: did }, function (data) {
                            data = $.parseJSON(data);
                            if (data.status === 1) {
                                $dd.datagrid("reload");
                                console.info($dd);
                    ...
                    $(".art_del_btn").click(function () {
                        ...
                        $.messager.confirm("提示", "删除后数据将不可找回!<br />请确认！", function (b) {
                            if (b) {                               
                                ...
                                $.delete_data("workerDelete.ashx", { did: did });
                            }
                        }); 
